...
public class AddClientOrderViewController extends RootViewController {
    ...
    private void selectedNumberOfPastOrders() {
        try {
    ...
    private void displayCorrectInsertionOption() {
    ...
    private void selectedManualSelection() {
        try {
    ...
    private void selectedClientArticles() {
        try {
    ...
    private void selectedProductsQuantity() {
        try {
    ...
    private void selectedUnavailableProductsQuantity() {
        try {
    ...
    public void onEvent(ViewEvent viewEvent) {
        switch (viewEvent) {
            ...
            case SELECTED_CLIENT -> this.selectedClient();
            case SELECT_INSERT_OPTIONS -> this.selectInsertOptions();
            case SELECTED_NUMBER_OF_PAST_ORDERS -> this.selectedNumberOfPastOrders();
            case SELECT_PRODUCTS -> this.displayCorrectInsertionOption();
            case SELECTED_MANUAL_SELECTION -> this.selectedManualSelection();
            case SELECTED_CLIENT_ARTICLES -> this.selectedClientArticles();
            case SELECTED_PRODUCTS -> this.selectedProducts();
            case SELECT_QUANTITY -> this.selectQuantity();
            case SELECTED_PRODUCTS_QUANTITY -> this.selectedProductsQuantity();
            case SELECT_UNAVAILABLE_PRODUCTS_QUANTITY -> this.selectUnavailableProductsQuantity();
            case SELECTED_UNAVAILABLE_PRODUCTS_QUANTITY -> this.selectedUnavailableProductsQuantity();
