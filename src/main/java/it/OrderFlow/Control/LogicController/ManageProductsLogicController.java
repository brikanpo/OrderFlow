...
public class ManageProductsLogicController extends TransactionSafeController {
    ...
    public void saveNewProduct(ProductBean productBean) throws Exception {
    ...
    public List<ArticleBean> getClientArticleList() throws Exception {
    ...
    public void saveNewProductInStock(ProductInStockBean productInStockBean) throws Exception {
